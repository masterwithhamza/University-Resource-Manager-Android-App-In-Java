...
public class cgpa7_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(cgpa7_activity.this, "GPA Calculated Successfully", Toast.LENGTH_SHORT).show();
                Float sub1,sub2,sub3,sub4,sub5,sub6,sub7,result,add;
                ...
                add = sub1+sub2+sub3+sub4+sub5+sub6+sub7;
                result=add/7;
                cgpa.setText(""+result);
        ...
        pro3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(cgpa7_activity.this, "Not Available", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private TextWatcher textWatcher=new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            gpa.setEnabled(!sub1.isEmpty() && !sub2.isEmpty() && !sub3.isEmpty() && !sub4.isEmpty()  && !sub5.isEmpty() && !sub6.isEmpty()  && !sub7.isEmpty());
