...
public class sgpa7_activity extends AppCompatActivity {
    EditText chFirst,gpFirst,chSecond,gpSecond,chThird,gpThird,chForth,gpForth,chfive,gpfive,chsix,gpsix,chseven,gpseven;
    Button gpa;
    TextView sGpa,tCraditH,tGradeP;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sgpa7);
        ...
        gpseven=findViewById(R.id.gpseven);
        ...
        chseven.addTextChangedListener(textWatcher);
        gpseven.addTextChangedListener(textWatcher);
        gpa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(sgpa7_activity.this, "GPA Calculated Successfully", Toast.LENGTH_SHORT).show();
                float sub1,sub2,sub3,sub4,sub5,sub6,sub7;
                float ch1,ch2,ch3,ch4,ch5,ch6,ch7;
                float gp1,gp2,gp3,gp4,gp5,gp6,gp7;
                float ch,total,GPA;
                ...
                ch7=Float.parseFloat(chseven.getText().toString());
                gp7=Float.parseFloat(gpseven.getText().toString());
                sub1=ch1*gp1;
                sub2=ch2*gp2;
                sub3=ch3*gp3;
                sub4=ch4*gp4;
                ...
                ch=(int)ch1+ch2+ch3+ch4+ch5+ch6+ch7;
                GPA=total/ch;
                tCraditH.setText(""+ch);
    ...
    private TextWatcher textWatcher=new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            String gp7=gpseven.getText().toString().trim();
            String ch7=chseven.getText().toString().trim();
            gpa.setEnabled(!ch1.isEmpty() && !ch2.isEmpty() && !gp1.isEmpty() && !gp2.isEmpty() && !gp3.isEmpty() && !ch3.isEmpty() && !gp4.isEmpty() && !ch4.isEmpty() && !gp5.isEmpty() && !ch5.isEmpty() && !gp6.isEmpty() && !ch6.isEmpty() && !gp7.isEmpty() && !ch7.isEmpty());
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id==R.id.gs)
        {
            Intent i=new Intent(sgpa7_activity.this , gradingsystem.class);
            startActivity(i);
        }
