...
public class sgpa5_activity extends AppCompatActivity {
    EditText chFirst,gpFirst,chSecond,gpSecond,chThird,gpThird,chForth,gpForth,chfive,gpfive;
    Button gpa;
    TextView sGpa,tCraditH,tGradeP;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sgpa5);
        ...
        gpa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(sgpa5_activity.this, "GPA Calculated Successfully", Toast.LENGTH_SHORT).show();
    ...
    private TextWatcher textWatcher=new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            gpa.setEnabled(!ch1.isEmpty() && !ch2.isEmpty() && !gp1.isEmpty() && !gp2.isEmpty() && !gp3.isEmpty() && !ch3.isEmpty() && !gp4.isEmpty() && !ch4.isEmpty() && !gp5.isEmpty() && !ch5.isEmpty());
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id==R.id.gs)
        {
            Intent i=new Intent(sgpa5_activity.this , gradingsystem.class);
            startActivity(i);
        }
